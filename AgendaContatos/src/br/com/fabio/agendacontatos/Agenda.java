...
public class Agenda {
	 ...
	 * A chave é a letra e o valor uma lista de contatos, cujo nome começa com a letra especificada
	 * na chave do map.
	 */
	private Map<Character, List<Contato>> contatosPorLetrasMap = new TreeMap<>();
	...
	/**
	 * Construtor. Ao criar o objeto, os registros cadastrados no arquivo 
	 * são lidos e adicionados na agenda (caso existam)
	 * @throws IOException
	 */
	...
	public void inserir(Contato contato) throws AgendaException, IOException {
		...
		// Obtem a letra inicial do nome do contato e adiciona o contato adequadamente
	...
	public void excluir(String nome) throws AgendaException, IOException {
		...
		// Obtem o contato associado ao nome
		...
		// Se depois da remoção não sobrar nenhum contato com a letra do nome no map, exclui o map
	...
	/**
	 * Obtem uma lista de contatos que iniciam com determinada letra
	...
	/**
	 * Obtem uma lista de contatos com base em parte do nome
	 * @param parteNome Parte do nome a ser procurada
	 * @return Lista de contatos que atendem ao critério
	 */
	public List<Contato> listarContatosPorParteNome(String parteNome) {
		// Procura por contatos que iniciam ou terminam por 0 ou mais caracteres e possuem, no nome
		// a string fornecida como parametro
		...
		// Lista dos contatos existentes atualmente. O método values() retorna os valores do map em forma de 
		// uma Collection
	...
	/**
	 * Obtem o objeto do contato cadastrado a partir de um nome
	 * @param nome Nome do contato
	 * @return Objeto que representa um contato
	 */
