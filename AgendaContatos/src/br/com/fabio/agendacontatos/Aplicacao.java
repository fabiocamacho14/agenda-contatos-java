...
public class Aplicacao {
	...
	public void iniciar() throws IOException {
		...
		// Fica em loop enquanto o usuario nao escolher a opção "Sair"
	 ...
	 * @throws IOException
	 */
	public void listarPorLetra() throws AgendaException, IOException {
		// Solicita a letra
		System.out.print("Letra: ");
		char letra = Console.readChar();
		
		// Obtem os contatos com base na letra
